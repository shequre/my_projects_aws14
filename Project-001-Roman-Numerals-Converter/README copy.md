...
```
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name thatsmykey --security-group-ids sg-00ccccc4f4ca6e92d --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh
or
...
aws ec2 run-instances \
    ...
    --key-name thatsmykey
    --security-groupwq-ids sg-00ccccc4f4ca6e92d
...
- To delete instances
```bash 
aws ec2 terminate-instances --instance-ids i-090a4907958e652e1 <We have already learned this id with query on above>
```
